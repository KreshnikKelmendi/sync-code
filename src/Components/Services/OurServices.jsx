        ...
        <div className='mt-14'>
          <div className='mb-4'>
            ...
            <div className='flex flex-col lg:flex-row items-end justify-between'>
              <p className='font-normal mt-3 lg:w-[90%] 2xl:text-lg text-gray-300'>
              ...
              <Link to='/web-development' onClick={() => window.scrollTo({ top: 0, left: 0 })} className='text-blue-500 hover:scale-110 hover:text-white'>Read more &rarr;</Link>
            </div>
          </div>
          ...
          <div className='mb-4 mt-12'>
            ...
            <div className='flex flex-col lg:flex-row items-end justify-between'>
              <p className='2xl:text-lg font-normal mt-3 lg:w-[90%] text-gray-300'>
