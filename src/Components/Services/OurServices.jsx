        ...
        <div className='mt-14'>
          <div className='mb-4'>
            ...
            <div className='flex flex-col lg:flex-row items-end justify-between'>
              <p className='font-normal mt-3 lg:w-[90%] 2xl:text-lg text-white'>
          ...
          <div className='mb-4 mt-12'>
            ...
            <div className='flex flex-col lg:flex-row items-end justify-between'>
              <p className='2xl:text-lg font-normal mt-3 lg:w-[90%] text-white'>
          ...
          <hr className='my-4 border-t-2 border-white' />
          <div className='mb-4 mt-12'>
            <p className='text-4xl lg:text-5xl 2xl:text-6xl font-semibold'>UI & UX Design</p>
            <div className='flex flex-col lg:flex-row items-end justify-between'>
              <p className='2xl:text-lg font-normal mt-3 lg:w-[90%] text-white'>
                  Our designers are passionate about pushing the boundaries of creativity. 
                  We stay updated with the latest design trends and technologies to ensure 
