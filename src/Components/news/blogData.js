...
const blogPosts = [
    ...
    // },
  {
    id: 2,
    date: "Oct 17, 2023",
    shortTitle: "Sync Code at New York Tech Week",
    description: "Sync Code participated in New York Tech Week from October 17, 2023, gaining valuable insights into the latest advancements in technology and artificial intelligence. Discover their experiences and how they are shaping the future of digital innovation.",
    secondDescription: "The event featured numerous keynote speeches, workshops, and networking sessions that provided Sync Code with unique opportunities to connect with industry leaders and innovators. They explored groundbreaking technologies and discussed potential collaborations that could drive the next wave of digital transformation. Through these interactions, Sync Code is poised to implement cutting-edge solutions and reinforce its position as a leader in the tech industry.",
    image: image2,
    image1: image3,
    image2: image4,
  },
